void printf(char* str) {
    unsigned short* VideoMemory = ((uint16_t*)0xb8000; // (unsigned short*) make 0xb8000 to be a address,which is the first dress of video memory.
...
extern "C" void kernelMain(void* multiboot_structure, uint32_t magic_number) { //multiboot_structure包含关于硬件、内存等信息；接收magicnumber验证是否是合法的BootLoader。
